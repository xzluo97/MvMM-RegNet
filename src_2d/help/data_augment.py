...
class DataAugmentation(object):
    ...
    def _get_augmented_data(self):
        augmented_data = dict(zip(['image', 'label'],
                                  layers_2d.random_affine_augment([self.data['image'], self.data['label']],
...
if __name__ == '__main__':
    ...
    # FA.augment(num_samples=1, save_path='./FFD_augmented_20', ffd_type=1, control_points=(30, 30, 30),
    #            random_type=0, mu=0, sigma=15)
